            ...
            <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
                ...
                <div className='space-y-12'>
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.5 }}
                    >
                        <h3 className='text-2xl font-semibold text-white mb-2'>Intermediate</h3>
                        <p className='text-gray-300 mb-2'>Government Junior College, Rourkela</p>
                        <p className='text-gray-400'>(2014 - 2016)</p>
                    </motion.div>
                    <div className='h-2 w-16 bg-gray-700 mx-auto'></div>
                    <motion.div
                        className='bg-gray-800 rounded-xl p-6 shadow-lg'
                        ...
                        transition={{ duration: 0.5 }}
                    >
                        <h3 className='text-2xl font-semibold text-white mb-2'>Matriculation</h3>
                        <p className='text-gray-300 mb-2'>Saint Mary's Convent School, Birmitrapur</p>
